<div x-data="{ isOpen: false }">
    <button x-on:click="isOpen = true; setTimeout(() => document.querySelector('#live-search-field').focus(), 50)" href="#" style="background: none; border: none; padding: 0; margin: 0; outline: none; cursor: pointer"
